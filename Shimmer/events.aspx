<%@ Page Title="" Language="C#" MasterPageFile="~/Shimmer.Master" AutoEventWireup="true" CodeBehind="events.aspx.cs" Inherits="Shimmer.events" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row p-3">
        ...
        <asp:DropDownList ID="ddlSort" CssClass="float-right" runat="server">
                ...
                <div class="col-4 h-100 mb-5">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            ...
                            <i class="far fa-calendar"> <asp:Label ID="lbEventDate" runat="server" Text=<%# string.Format("{0:dd/MM/yyyy }", Eval("eventStartDateTime"))%>></asp:Label></i><br />
                            <i class="far fa-clock"> <asp:Label ID="lbEventTime" runat="server" Text=<%# string.Format("{0:hh:mm tt }", Eval("eventStartDateTime"))%>></asp:Label></i><br />
                            
                            <i class="far fa-hourglass"><asp:Label ID="lbEventDuration" runat="server" Text=<%# " "+Eval("eventDuration") %>></asp:Label></i><br />
                            <i class="far fa-compass"> <asp:Label ID="lbEventLocation" runat="server" Text=<%# Eval("eventLocation") %>></asp:Label></i><br />
                            <a href="viewevent.aspx?eventid=<%# Eval("Id") %>" class="btn btn-primary mt-2">More information</a>
                        </div>
                    </div>
                </div>
            </ItemTemplate>
